...
| `grafana_dashboards_dir` | "dashboards" | Path to a local directory containing dashboards files in `json` format. Each subdirectory inside this folder will be detected by Grafana as dashboard folder |
